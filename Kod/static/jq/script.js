...
elem = elem+ id + '">';
elem = elem + '<a id ="jsclose" href="javascript:void(0)" onclick="showReplyBox(44,142,1);">Close</a><textarea name="text" placeholder="Comment" maxlength="100" rows="5" cols="50"></textarea><hr><input id="jsaddfile" type="file" name="commentimg" accept="image/*"><input id="jsaddcomment" type="submit" value="Spara innehåll"></form>';
...
elem = elem+ id + '">';
elem = elem + '<a id ="jsclose" href="javascript:void(0)" onclick="showReplyBox(44,142,1);">Close</a><textarea name="text" placeholder="Comment" maxlength="100" rows="5" cols="50"></textarea><hr><input id="jsaddfile" type="file" name="commentcommentimg" accept="image/*"><input id="jsaddcomment" type="submit" value="Spara innehåll"></form>';
    var empty = ""; 
